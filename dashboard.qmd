...
contributions_summary$map_activity_age <- as.integer(
      difftime(contributions_summary$date_last_map_edit, contributions_summary$date_creation, units = "days")
    ) / 365
...
wordcloud_hashtag <- wordcloud(words = word_corpus$hashtags, 
                               freq = word_corpus$n, 
                               min.freq = 1, 
                               random.order=FALSE, 
